...
export const products: Product[] = [
  ...
  { id: 27, name: 'Fakhar Platinum',       description: 'A crisp aromatic of bergamot, geranium and earthy patchouli.', price: 0, emoji: '💎', image: '/products/fakhar-platinum.png', category: 'Aromatic · Fresh', mood: ['fresh', 'woody'], notes: ['Bergamot', 'Geranium', 'Patchouli'], rating: 4.7 },
  { id: 28, name: 'Jasoor',                description: 'A spicy woody composition of oud, spice and warm amber.', price: 0, emoji: '🪵', image: '/products/jasoor.png', category: 'Woody · Oriental', mood: ['woody', 'oriental'], notes: ['Oud', 'Spice', 'Amber'], rating: 4.6 },

  // ───────── Ana Abiyedh line ─────────
  { id: 29, name: 'Ana Abiyedh Coral',     description: 'A fresh fruity-floral of apple, soft blossoms and clean musk.', price: 0, emoji: '🪸', image: '/products/ana-abiyedh-coral.png', category: 'Fruity · Floral', mood: ['fruity', 'floral'], notes: ['Apple', 'Floral', 'Musk'], rating: 4.6 },
  { id: 30, name: 'Ana Abiyedh Leather',   description: 'Supple leather wrapped in spice and smooth woods.', price: 0, emoji: '🤎', image: '/products/ana-abiyedh-leather.png', category: 'Leather · Woody', mood: ['woody', 'oriental'], notes: ['Leather', 'Spice', 'Woods'], rating: 4.6 },
  { id: 31, name: 'Ana Abiyedh Rouge',     description: 'An addictive sweet-amber glow of saffron, amberwood and cedar.', price: 0, emoji: '❤️', image: '/products/ana-abiyedh-rouge.png', category: 'Sweet · Oriental', mood: ['sweet', 'oriental'], notes: ['Saffron', 'Amberwood', 'Cedar'], rating: 4.8, badge: 'POPULAR' },
  { id: 32, name: 'Ana Abiyedh Scarlet',   description: 'Ripe berries and rose softened by creamy vanilla.', price: 0, emoji: '🍓', image: '/products/ana-abiyedh-scarlet.png', category: 'Fruity · Floral', mood: ['fruity', 'floral'], notes: ['Berries', 'Rose', 'Vanilla'], rating: 4.6 },

  // ───────── Mayar / Bint Hoorain / misc ─────────
  { id: 33, name: 'Mayar',                 description: 'A radiant floral of bergamot, rose and soft vanilla.', price: 0, emoji: '💗', image: '/products/mayar.png', category: 'Floral · Fruity', mood: ['floral', 'fruity'], notes: ['Bergamot', 'Rose', 'Vanilla'], rating: 4.7 },
  { id: 34, name: 'Mayar Cherry',          description: 'Juicy cherry and almond folded into warm vanilla.', price: 0, emoji: '🍒', image: '/products/mayar-cherry.png', category: 'Fruity · Sweet', mood: ['fruity', 'sweet'], notes: ['Cherry', 'Almond', 'Vanilla'], rating: 4.7 },
  ...
  { id: 37, name: 'Layaan',                description: 'A soft delicate floral with a powdery musky drydown.', price: 0, emoji: '🌼', image: '/products/layaan.png', category: 'Floral', mood: ['floral'], notes: ['White Flowers', 'Powder', 'Musk'], rating: 4.5 },
  { id: 38, name: 'Petra',                 description: 'A warm oriental of amber, spice and resinous woods.', price: 0, emoji: '🏜️', image: '/products/petra.png', category: 'Oriental', mood: ['oriental', 'woody'], notes: ['Amber', 'Spice', 'Woods'], rating: 4.6 },
  ...
  // ───────── 50ml signatures ─────────
  { id: 52, name: 'Yara 50ml',             description: 'A creamy floral of orchid, heliotrope and vanilla sandalwood.', price: 0, emoji: '💜', image: '/products/yara.png', category: 'Floral · Sweet', mood: ['floral', 'sweet'], notes: ['Orchid', 'Heliotrope', 'Vanilla'], rating: 4.8, badge: 'BESTSELLER' },
  { id: 53, name: 'Qaed Fursan 50ml',      description: 'A fresh fruity-amber of pineapple, bergamot and amber.', price: 0, emoji: '🐎', image: '/products/qaed-al-fursan.png', category: 'Fresh · Fruity', mood: ['fresh', 'fruity'], notes: ['Pineapple', 'Bergamot', 'Amber'], rating: 4.7 },
  ...
  { id: 55, name: 'Ameerat 50ml',          description: 'A regal floral with fruity facets and a musky base.', price: 0, emoji: '👑', image: '/products/ameerat.png', category: 'Floral', mood: ['floral', 'fruity'], notes: ['Floral', 'Fruits', 'Musk'], rating: 4.6 },
  ...
  { id: 61, name: 'Ana Abiyedh 50ml',      description: 'A clean fresh-white of apple, white florals and musk.', price: 0, emoji: '🤍', image: '/products/ana-abiyedh.png', category: 'Fresh · Floral', mood: ['fresh', 'floral'], notes: ['Apple', 'White Flowers', 'Musk'], rating: 4.6 },
  ...
  { id: 67, name: 'Oud Mood 50ml',         description: 'A smoky mood of oud, rose and saffron.', price: 0, emoji: '🪵', image: '/products/oud-mood.png', category: 'Woody · Oud', mood: ['woody', 'oriental'], notes: ['Oud', 'Rose', 'Saffron'], rating: 4.7 },
  ...
  // ───────── 10ml travel sizes ─────────
  { id: 69, name: 'Yara 10ml',             description: 'Travel size of the creamy orchid-vanilla bestseller.', price: 0, emoji: '💜', image: '/products/yara.png', category: 'Floral · Sweet · Travel', mood: ['floral', 'sweet'], notes: ['Orchid', 'Heliotrope', 'Vanilla'], rating: 4.7 },
  ...
  { id: 89,  name: 'Yara Candy',          description: 'A candied twist on Yara — sweet sugar, fruit and vanilla.', price: 0, emoji: '🍬', image: '/products/yara-candy.png', category: 'Sweet · Fruity', mood: ['sweet', 'fruity'], notes: ['Candy', 'Fruits', 'Vanilla'], rating: 4.7 },
  { id: 90,  name: 'Asad',               description: 'A bold masculine of pineapple, blackcurrant and tobacco.', price: 0, emoji: '🦁', image: '/products/asad.png', category: 'Woody · Spicy', mood: ['woody', 'oriental'], notes: ['Pineapple', 'Blackcurrant', 'Tobacco'], rating: 4.7, badge: 'POPULAR' },
  ...
  { id: 92,  name: 'Badee Oud Sublime',  description: 'A sublime oud of oud, saffron and sweet vanilla.', price: 0, emoji: '🪵', image: '/products/badee-oud-sublime.png', category: 'Woody · Oud', mood: ['woody', 'oriental'], notes: ['Oud', 'Saffron', 'Vanilla'], rating: 4.7 },
  { id: 93,  name: 'Badee Oud Noble',    description: 'A noble oud of oud, rose and warm amber.', price: 0, emoji: '🪵', image: '/products/badee-oud-noble.png', category: 'Woody · Oud', mood: ['woody', 'oriental'], notes: ['Oud', 'Rose', 'Amber'], rating: 4.7 },
  { id: 94,  name: 'Fakhar Man',         description: 'A fresh aromatic fougère of bergamot, lavender and woods.', price: 0, emoji: '🧔', image: '/products/fakhar-man.png', category: 'Aromatic · Fresh', mood: ['fresh', 'woody'], notes: ['Bergamot', 'Lavender', 'Woods'], rating: 4.6 },
  { id: 95,  name: 'Fakhar Women',       description: 'A graceful floral of jasmine, rose and musk.', price: 0, emoji: '👩', image: '/products/fakhar-women.png', category: 'Floral', mood: ['floral'], notes: ['Jasmine', 'Rose', 'Musk'], rating: 4.6 },
  { id: 96,  name: 'Eclaire',            description: 'A decadent gourmand of caramel, vanilla and tonka.', price: 0, emoji: '🍫', image: '/products/eclaire.png', category: 'Sweet · Gourmand', mood: ['sweet'], notes: ['Caramel', 'Vanilla', 'Tonka Bean'], rating: 4.7 },
  { id: 97,  name: 'Eclaire Biscoff',    description: 'A cookie-butter gourmand of biscuit, caramel and vanilla.', price: 0, emoji: '🍪', image: '/products/eclaire-biscoff.png', category: 'Sweet · Gourmand', mood: ['sweet'], notes: ['Biscuit', 'Caramel', 'Vanilla'], rating: 4.7 },
  { id: 98,  name: 'Eclaire Pistachio',  description: 'A creamy gourmand of pistachio, cream and vanilla.', price: 0, emoji: '🥧', image: '/products/eclaire-pistachio.png', category: 'Sweet · Gourmand', mood: ['sweet'], notes: ['Pistachio', 'Cream', 'Vanilla'], rating: 4.7 },
  { id: 99,  name: 'Khamrah Qahwa',      description: 'A coffee gourmand of cardamom coffee, dates and vanilla.', price: 0, emoji: '☕', image: '/products/khamrah-qahwa.png', category: 'Sweet · Spicy', mood: ['sweet', 'oriental'], notes: ['Coffee', 'Cardamom', 'Vanilla'], rating: 4.8, badge: 'BESTSELLER' },
  { id: 100, name: 'Khamrah',            description: 'A warm spicy-gourmand of cinnamon, dates and vanilla.', price: 0, emoji: '🤎', image: '/products/khamrah.png', category: 'Sweet · Spicy', mood: ['sweet', 'oriental'], notes: ['Cinnamon', 'Dates', 'Vanilla'], rating: 4.8 },
  { id: 101, name: 'Angham',             description: 'A melodic floral-fruity of bergamot, jasmine and vanilla.', price: 0, emoji: '🎶', image: '/products/angham.png', category: 'Floral · Fruity', mood: ['floral', 'fruity'], notes: ['Bergamot', 'Jasmine', 'Vanilla'], rating: 4.6 },
  { id: 102, name: 'Habik Red',          description: 'A warm oriental of saffron, amber and woods.', price: 0, emoji: '❤️', image: '/products/habik-red.png', category: 'Oriental', mood: ['oriental', 'woody'], notes: ['Saffron', 'Amber', 'Woods'], rating: 4.6 },
  ...
  { id: 104, name: 'Habik for Women',    description: 'A feminine floral of rose, peony and soft musk.', price: 0, emoji: '💗', image: '/products/habik-women.png', category: 'Floral', mood: ['floral'], notes: ['Rose', 'Peony', 'Musk'], rating: 4.6 },
  { id: 105, name: 'Vintage Radio',      description: 'A nostalgic aromatic of lavender, cinnamon and vanilla.', price: 0, emoji: '📻', image: '/products/vintage-radio.png', category: 'Aromatic · Woody', mood: ['woody', 'fresh'], notes: ['Lavender', 'Cinnamon', 'Vanilla'], rating: 4.6 },
  { id: 106, name: 'Nebras Elixir',      description: 'A glowing sweet elixir of amber, fruit and vanilla.', price: 0, emoji: '✨', image: '/products/nebras-elixir.png', category: 'Sweet · Oriental', mood: ['sweet', 'oriental'], notes: ['Amber', 'Fruits', 'Vanilla'], rating: 4.6 },
  ...
  { id: 108, name: 'Yara Elixir',        description: 'A richer Yara elixir of orchid, fruit and vanilla.', price: 0, emoji: '💜', image: '/products/yara-elixir.png', category: 'Floral · Sweet', mood: ['floral', 'sweet'], notes: ['Orchid', 'Fruits', 'Vanilla'], rating: 4.7 },
